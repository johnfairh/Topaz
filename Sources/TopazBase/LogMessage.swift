...
public protocol LogMessageEmitter {
...
public extension LogMessageEmitter {
    ...
    func log(_ level: LogLevel, _ body: @autoclosure @escaping () -> String) {
        logMessageHandler(LogMessage(level, { "[\(self.logMessagePrefix)] \(body())" }))
    }

    /// By default there is no prefix
    var logMessagePrefix: String { return "" }
}
